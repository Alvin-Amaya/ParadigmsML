...
#ifndef GRPC_ml_5fcontract_2eproto__INCLUDED
#define GRPC_ml_5fcontract_2eproto__INCLUDED
...
class MLPredictor final {
 public:
  static constexpr char const* service_full_name() {
    return "ml_paradigm.MLPredictor";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    virtual ::grpc::Status Predict(::grpc::ClientContext* context, const ::ml_paradigm::PredictionRequest& request, ::ml_paradigm::PredictionResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::ml_paradigm::PredictionResponse>> AsyncPredict(::grpc::ClientContext* context, const ::ml_paradigm::PredictionRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::ml_paradigm::PredictionResponse>>(AsyncPredictRaw(context, request, cq));
    }
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status Predict(::grpc::ClientContext* context, const ::ml_paradigm::PredictionRequest& request, ::ml_paradigm::PredictionResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::ml_paradigm::PredictionResponse>> AsyncPredict(::grpc::ClientContext* context, const ::ml_paradigm::PredictionRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::ml_paradigm::PredictionResponse>>(AsyncPredictRaw(context, request, cq));
    }
  ...
  class WithAsyncMethod_Predict : public BaseClass {
   ...
   public:
    ...
    void RequestPredict(::grpc::ServerContext* context, ::ml_paradigm::PredictionRequest* request, ::grpc::ServerAsyncResponseWriter< ::ml_paradigm::PredictionResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_Predict() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::ml_paradigm::PredictionRequest, ::ml_paradigm::PredictionResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::ml_paradigm::PredictionRequest* request, ::ml_paradigm::PredictionResponse* response) { return this->Predict(context, request, response); }));}
    void SetMessageAllocatorFor_Predict(
        ::grpc::MessageAllocator< ::ml_paradigm::PredictionRequest, ::ml_paradigm::PredictionResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::ml_paradigm::PredictionRequest, ::ml_paradigm::PredictionResponse>*>(handler)
    ...
    WithStreamedUnaryMethod_Predict() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::ml_paradigm::PredictionRequest, ::ml_paradigm::PredictionResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::ml_paradigm::PredictionRequest, ::ml_paradigm::PredictionResponse>* streamer) {
...
#endif  // GRPC_ml_5fcontract_2eproto__INCLUDED
